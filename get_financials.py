...
try:
    ...
    # 여기서는 연간 데이터를 조회합니다.
    df_financials = stock.get_market_fundamental(str_end_date)
    if df_financials.empty:
        ...
        df_financials = df_financials.reset_index() # Ticker becomes first column
